<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <!-- <img src="public/imagens/png-transparent-cinema-logo-rio-de-janeiro-film-2018-film-society-archives-recordkeeping-in-society-german-language-food.png" alt=""> -->
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('perfil') }}" :active="request()->routeIs('perfil')">
                                {{ __('Profile') }}
                            </x-dropdown-link>
    ...
    <ul class="buttons">
        ...
        <li class="nav-item">
            <a href="/events/create" class="nav-link">Salas</a>
        </li>
        <li class="nav-item">
